...
import { YuksekGelirlerListesi } from "./table";
...
export function YuksekGelir() {
  ...
  async function onSubmit(data: ProfileFormValues) {
    ...
    const response = await axios.post(endPoints.nil_30bin_uzeri_gelir.post, {
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList>
          <TabsTrigger value="overview">
            30.000 TL Üzeri Gelir Ekleme
          </TabsTrigger>
          <TabsTrigger value="gelir-gider-listesi">
            30.000 TL Üzeri Gelir Listesi
          </TabsTrigger>
        </TabsList>
