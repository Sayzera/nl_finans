...
import { YuksekGiderlerListesi } from "./table";

const profileFormSchema = z.object({
  islem_adedi: z.string({
...
export function YuksekGiderler() {
  ...
  async function onSubmit(data: ProfileFormValues) {
    ...
    const response = await axios.post(endPoints.nil_50bin_uzeri_gider.post, {
      adet: data.islem_adedi,
      tarih: data.tarih,
      tutar: data.tutar,
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList>
          <TabsTrigger value="overview">
            50.000 TL Üzeri Gider Ekleme
          </TabsTrigger>
          <TabsTrigger value="gelir-gider-listesi">
            50.000 TL Üzeri Gider Listesi
          </TabsTrigger>
        </TabsList>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>İşlem Adeti</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
